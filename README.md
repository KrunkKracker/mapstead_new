...
> [!WARNING]
> This is unreleased development software (v0.02). It is currently in a basemap runtime hardening pass (Phase 2.2h5R8).

- **Phase 2.2h5R8 (Recreation Lifecycle and Version Closure)**: IMPLEMENTED / EXTERNAL REVIEW PENDING.
