...
class AccuracyPanelRegressionTest {
    ...
    private val mockLocation = LocationResult.Success(
        latitude = 45.0,
        longitude = -75.0,
        accuracyMeters = 12.34f,
    ...
    @Test
    fun testAccuracyPanelCompactGood() = runAccuracyPanelTest(compactLayout, LocationAccuracyQuality.Good, "Good Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    @Test
    fun testAccuracyPanelCompactModerate() = runAccuracyPanelTest(compactLayout, LocationAccuracyQuality.Moderate, "Moderate Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    @Test
    fun testAccuracyPanelCompactPoor() = runAccuracyPanelTest(compactLayout, LocationAccuracyQuality.Poor, "Poor Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    @Test
    fun testAccuracyPanelExpandedGood() = runAccuracyPanelTest(expandedLayout, LocationAccuracyQuality.Good, "Good Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    @Test
    fun testAccuracyPanelExpandedModerate() = runAccuracyPanelTest(expandedLayout, LocationAccuracyQuality.Moderate, "Moderate Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    @Test
    fun testAccuracyPanelExpandedPoor() = runAccuracyPanelTest(expandedLayout, LocationAccuracyQuality.Poor, "Poor Accuracy")

    @OptIn(ExperimentalMaterial3Api::class)
    private fun runAccuracyPanelTest(layout: AdaptiveLayoutInfo, quality: LocationAccuracyQuality, qualityText: String) {
        composeTestRule.setContent {
            MapScreenContent(
                layoutInfo = layout,
                state = MapUiState(
                    currentPhoneLocation = mockLocation,
                    currentPhoneLocationQuality = quality
                ),
        ...
        composeTestRule.onNodeWithTag("AccuracyPanel").assertIsDisplayed()
        composeTestRule.onNodeWithText("Accuracy: 12.3 m").assertIsDisplayed()
        composeTestRule.onNodeWithText(qualityText).assertIsDisplayed()
        composeTestRule.onNodeWithText("Hide Location").assertIsDisplayed()
