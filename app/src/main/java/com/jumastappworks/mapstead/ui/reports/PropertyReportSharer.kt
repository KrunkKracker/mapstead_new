...
sealed interface ReportShareResult {
    ...
    data object FileMissing : ReportShareResult
    data object InvalidFileLocation : ReportShareResult
    data object NoShareTarget : ReportShareResult
    data object PermissionFailure : ReportShareResult
    data object Error : ReportShareResult
}

@Singleton
class PropertyReportSharer @Inject constructor(
    ...
    fun share(file: File): ReportShareResult {
        ...
        return try {
            ...
            if (!isFileInsideDirectory(reportsDir, file)) {
            ...
            val intent = Intent(Intent.ACTION_SEND).apply {
                ...
                clipData = ClipData.newRawUri(context.getString(R.string.report_share_label), uri)
            }

            val chooser = Intent.createChooser(intent, context.getString(R.string.report_share_chooser_title)).apply {
                addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
            }
